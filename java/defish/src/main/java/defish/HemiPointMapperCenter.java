 ...
 */
public class HemiPointMapperCenter extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HemiPointMapperCenter::new);
    }

    public HemiPointMapperCenter() {
 ...
 // Call AFTER both images are opened (so we know current sizes).
    ...
    static class ImagePane extends JComponent {
        ...
        private void repaintSiblings(){
            ...
            if (w instanceof HemiPointMapperCenter) ((HemiPointMapperCenter)w).updateStatus();
        }
